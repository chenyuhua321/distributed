...
<script type="text/javascript">
    ...
    function doDelete(id) {
        $.ajax({
            type: "DELETE",
            url: "/session/resume/delete?id=" + id,
            success: function (data) {
                console.log(data);
                alert("删除成功")
                //首先清空表格残留数据
    ...
    function doQueryByID(id) {
        $.ajax({
            type: "POST",
            url: "/session/resume/queryById?id=" + id,
            dataType: "json",
            success: function (data) {
                if (data != null) {
                    //赋值
